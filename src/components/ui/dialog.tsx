...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-2xl text-accent leading-none font-semibold",
        className
      )}
      {...props}
    />
